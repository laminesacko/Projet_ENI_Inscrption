...
import 'package:mini_projet_debut/Acceuil/Fili%C3%A8re.dart';
      ...
      body: IndexedStack(
        ...
        children: [
          NestedScrollView(
            ...
            body: Column(
              children: [
                SizedBox(child: Text("Bonjour Oumou")),
                SizedBox(
                  height: 120,
          ...
          Scaffold(body: Center(child: Text("Inscription")),),
          Scaffold(body: Center(child: Text("Ressources")),),
